...
var config = {
    user: 'deveshprakashsingh',
    database: 'deveshprakashsingh',
...
app.get('/hash/:input', function(req,res){
    var hashedString = hash(req.params.input,"this is some salt");
...
app.post('/create-user',function(req,res){
    //username, password
    //{"username": "devesh", "password": "password"}
    //json
...
app.post('/login',function(req,res){
    var username = req.body.username;
    var password = req.body.password;
    pool.qwery('SELECT * from "user" WHERE username = $1',[username],function(err,result){
        if(err){
            res.status(500).send(err.toString());
        } else {
